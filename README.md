...
**`bc-sskr-ts`** splits a secret into shares across one or more groups, and reconstructs it from any sufficient quorum.
...
[@blockchaincommons/sskr](https://www.npmjs.com/package/@blockchaincommons/sskr) is published to npm. Install it with your package manager of choice:

```sh
npm install @blockchaincommons/sskr
# or
pnpm add @blockchaincommons/sskr
# or
yarn add @blockchaincommons/sskr
# or
...
// Every failure is an SskrError; branch with `is`. Spec and header fields are
...
`bc-sskr-ts` is currently under active development and in beta testing. It should not be used for production tasks until it has had further testing and auditing. See [Blockchain Commons' Development Phases](https://github.com/BlockchainCommons/Community/blob/master/release-path.md).
...
`@blockchaincommons/sskr` depends on `@blockchaincommons/rand`, `@blockchaincommons/shamir` at runtime.
...
As an open-source, open-development community, Blockchain Commons does not have the resources to provide direct support of our projects. Please consider the discussions area as a locale where you might get answers to questions. Alternatively, please use this repository's [issues](https://github.com/BlockchainCommons/bc-sskr-ts/issues) feature. Unfortunately, we can not make any promises on response time.
